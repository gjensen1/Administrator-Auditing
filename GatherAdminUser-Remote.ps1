...
$OutputDir = Join-Path "\\<networkShare>" $Date
$ServerList = "C:\Users\<username>\Documents\PowerShellScripts\Administrator Auditing\SysTrustServerList.txt"
...
$OutputFile = Join-Path $OutputDir "$Computer-$Date-Initial.csv"
